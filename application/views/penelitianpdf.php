   ...
   <table id="tblhadir" class="table table-bordered table-striped table-hover" style="width:100% !important;">
    <thead>
          <tr>
            ...
            <th style="font-size:12px; text-align:left;">Judul</th>
  		...
  		<tr>
            ...
            <td style="font-size:12px;"><?php echo $nil['penelitianJudul']; ?></td>
            <td style="font-size:12px;"><?php echo $nil['penelitianKeterangan']; ?></td>
  		</tr>
  		<?php }} ?>
